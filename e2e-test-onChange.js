...
async function runTests() {
  ...
  try {
    console.log('\n🚀 RUNNING E2E TESTS WITH onChange VALIDATION MODE\n');
    ...
    // Test 2: Empty Fields Validation on onChange
    console.log('\n📝 TEST 2: Empty Fields Validation (onChange)');
    try {
      // Type and then clear - this triggers onChange validation
    ...
    // Test 3: Password Validation - Missing Uppercase (onChange)
    console.log('\n📝 TEST 3: Password Validation - Missing Uppercase (onChange)');
    try {
    ...
    // Test 6: Email Validation (onChange)
    console.log('\n📝 TEST 6: Email Format Validation (onChange)');
    try {
