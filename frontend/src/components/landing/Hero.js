                            ...
                            ease: 'easeInOut',
                                        ...
                                        { icon: Smartphone, text: 'Mobile access included' },
                                            ...
                                            backgroundColor: 'rgba(55, 65, 81, 0.5)',
                                                    ...
                                                    repeat: Infinity,
                                                    delay: i * 0.3,
                                                }, children: _jsx(item.icon, { className: "w-5 h-5 text-accent-400 flex-shrink-0" }) }), _jsx("span", { className: "text-sm text-primary-100", children: item.text })] }, i))) })] }) }), _jsx(motion.div, { className: "absolute bottom-8 left-1/2 transform -translate-x-1/2 text-center", animate: {
                            y: [0, 10, 0],
                        }, transition: {
                            duration: 2,
                            repeat: Infinity,
                        }, children: _jsxs("div", { className: "flex flex-col items-center gap-2 text-blue-300", children: [_jsx("span", { className: "text-sm font-medium", children: "Scroll to explore" }), _jsx("svg", { className: "w-6 h-6 animate-bounce", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M19 14l-7 7m0 0l-7-7m7 7V3" }) })] }) })] })] }));
}
