...
export default function Features() {
    return (_jsx("section", { id: "features", className: "py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-warm-walnut-brown to-warm-coffee transition-colors duration-normal", children: _jsxs("div", { className: "max-w-7xl mx-auto", children: [_jsxs("div", { className: "text-center mb-16 animate-fadeIn", children: [_jsxs("h2", { className: "text-4xl sm:text-5xl font-bold text-white mb-4 leading-tight tracking-tight", children: ["Everything You Need to", ' ', _jsx("span", { className: "text-warm-copper", children: "Stay Connected" })] }), _jsx("p", { className: "text-lg text-warm-100 max-w-3xl mx-auto font-light leading-relaxed", children: "Powerful features designed specifically for churches managing multiple locations and hundreds of members." })] }), _jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-8", children: features.map((feature, index) => (_jsxs(Card, { variant: "default", className: "group animate-slideUp p-8 bg-gradient-to-br from-warm-brown-sugar to-warm-raw-umber border border-warm-coffee hover:shadow-dual-lg transition-all duration-normal", style: { animationDelay: `${index * 0.1}s` }, children: [_jsx("div", { className: "w-12 h-12 bg-warm-coyote text-warm-copper rounded-lg flex items-center justify-center mb-5 group-hover:bg-warm-copper group-hover:text-white transition-colors duration-normal", children: feature.icon }), _jsx("h3", { className: "text-lg font-semibold text-white mb-3", children: feature.title }), _jsx("p", { className: "text-warm-100 text-sm leading-relaxed", children: feature.description })] }, index))) })] }) }));
}
