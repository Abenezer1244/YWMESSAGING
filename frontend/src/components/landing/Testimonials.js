...
export default function Testimonials() {
    ...
    return (_jsxs("section", { id: "testimonials", className: "relative py-20 px-4 sm:px-6 lg:px-8 bg-background overflow-hidden transition-colors duration-normal", children: [_jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [_jsx(motion.div, { className: "absolute top-1/3 right-0 w-96 h-96 bg-primary opacity-10 rounded-full blur-3xl", animate: {
                            y: [0, 40, 0],
                            x: [0, 30, 0],
                        }, transition: {
                            duration: 12,
                            ...
                            delay: 0.7,
                                            ...
                                            backgroundSize: '200% 200%',
                                                    ...
                                                    repeat: Infinity,
                                                    delay: index * 0.3,
                                                }, children: _jsx(Quote, { className: "w-10 h-10 text-primary opacity-70" }) }), _jsxs("p", { className: "text-foreground mb-6 leading-relaxed italic text-sm", children: ["\"", testimonial.content, "\""] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-12 h-12 bg-primary rounded-full flex items-center justify-center text-background font-semibold text-base flex-shrink-0", children: testimonial.name.charAt(0) }), _jsxs("div", { children: [_jsx("div", { className: "font-semibold text-foreground dark:text-foreground text-sm", children: testimonial.name }), _jsxs("div", { className: "text-xs text-muted-foreground", children: [testimonial.role, ", ", testimonial.church] })] })] })] })] }) }, index))) }), _jsx(motion.div, { className: "mt-16 pt-12 border-t border-primary/30", initial: { opacity: 0 }, whileInView: { opacity: 1 }, transition: { duration: 0.8 }, viewport: { once: true }, children: _jsxs(motion.div, { className: "grid grid-cols-2 md:grid-cols-4 gap-8 text-center", variants: containerVariants, initial: "hidden", whileInView: "visible", viewport: { once: true }, children: [_jsxs(motion.div, { initial: { opacity: 0, scale: 0.8 }, whileInView: { opacity: 1, scale: 1 }, transition: { duration: 0.6, delay: 0.2 }, viewport: { once: true }, children: [_jsx(motion.div, { className: "text-4xl font-bold bg-gradient-to-r from-primary to-primary bg-clip-text text-transparent mb-2", animate: {
                                                y: [0, -3, 0],
                                            }, transition: {
                                                duration: 2,
                                                repeat: Infinity,
                                            }, children: "100+" }), _jsx("div", { className: "text-muted-foreground text-sm", children: "Churches" })] }), _jsxs(motion.div, { initial: { opacity: 0, scale: 0.8 }, whileInView: { opacity: 1, scale: 1 }, transition: { duration: 0.6, delay: 0.3 }, viewport: { once: true }, children: [_jsx(motion.div, { className: "text-4xl font-bold bg-gradient-to-r from-primary to-primary bg-clip-text text-transparent mb-2", animate: {
                                                y: [0, -3, 0],
                                            }, transition: {
                                                duration: 2.2,
                                                repeat: Infinity,
                                            }, children: "25K+" }), _jsx("div", { className: "text-muted-foreground text-sm", children: "Members" })] }), _jsxs(motion.div, { initial: { opacity: 0, scale: 0.8 }, whileInView: { opacity: 1, scale: 1 }, transition: { duration: 0.6, delay: 0.4 }, viewport: { once: true }, children: [_jsx(motion.div, { className: "text-4xl font-bold bg-gradient-to-r from-primary to-primary bg-clip-text text-transparent mb-2", animate: {
                                                y: [0, -3, 0],
                                            }, transition: {
                                                duration: 2.4,
                                                repeat: Infinity,
                                            }, children: "500K+" }), _jsx("div", { className: "text-muted-foreground text-sm", children: "Messages Sent" })] }), _jsxs(motion.div, { initial: { opacity: 0, scale: 0.8 }, whileInView: { opacity: 1, scale: 1 }, transition: { duration: 0.6, delay: 0.5 }, viewport: { once: true }, children: [_jsx(motion.div, { className: "text-4xl font-bold bg-gradient-to-r from-primary to-primary bg-clip-text text-transparent mb-2", animate: {
                                                y: [0, -3, 0],
                                            }, transition: {
                                                duration: 2.6,
                                                repeat: Infinity,
                                            }, children: "99.9%" }), _jsx("div", { className: "text-muted-foreground text-sm", children: "Uptime" })] })] }) })] })] }));
}
