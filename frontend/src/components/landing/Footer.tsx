...
export default function Footer() {
  return (
    <footer className="relative bg-gradient-to-b from-primary-900 to-primary-950 border-t border-accent-500/30 backdrop-blur-sm transition-colors duration-normal overflow-hidden">
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-5">
              {/* Social media icons */}
              <a href="#" className="text-accent-400 hover:text-accent-500 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="#features" className="text-primary-100 hover:text-accent-500 transition-colors">
                  Features
                </a>
              </li>
              <li>
                <a href="#pricing" className="text-primary-100 hover:text-accent-500 transition-colors">
                  Pricing
                </a>
              </li>
              <li>
                <a href="#testimonials" className="text-primary-100 hover:text-accent-500 transition-colors">
                  Testimonials
                </a>
              </li>
              <li>
                <Link to="/register" className="text-primary-100 hover:text-accent-500 transition-colors">
                  Start Free Trial
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="#" className="text-primary-100 hover:text-accent-500 transition-colors">
                  About Us
                </a>
              </li>
              <li>
                <a href="mailto:support@connect.com" className="text-primary-100 hover:text-accent-500 transition-colors">
                  Contact
                </a>
              </li>
              <li>
