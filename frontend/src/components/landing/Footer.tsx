        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-4">
              <div className="w-9 h-9 bg-blue-pacific rounded-lg flex items-center justify-center">
            ...
            <div className="flex gap-5">
              {/* Social media icons */}
              <a href="#" className="text-blue-400 hover:text-blue-pacific transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="#features" className="text-blue-100 hover:text-blue-pacific transition-colors">
                  Features
                </a>
              </li>
              <li>
                <a href="#pricing" className="text-blue-100 hover:text-blue-pacific transition-colors">
                  Pricing
                </a>
              </li>
              <li>
                <a href="#testimonials" className="text-blue-100 hover:text-blue-pacific transition-colors">
                  Testimonials
                </a>
              </li>
              <li>
                <Link to="/register" className="text-blue-100 hover:text-blue-pacific transition-colors">
                  Start Free Trial
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="#" className="text-blue-100 hover:text-blue-pacific transition-colors">
                  About Us
                </a>
              </li>
              <li>
                <a href="mailto:support@connect.com" className="text-blue-100 hover:text-blue-pacific transition-colors">
                  Contact
                </a>
              </li>
              <li>
