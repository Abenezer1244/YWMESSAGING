...
export default function Pricing() {
    ...
    return (_jsxs("section", { id: "pricing", className: "relative py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-950 overflow-hidden transition-colors duration-normal", children: [_jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [_jsx(motion.div, { className: "absolute top-0 right-1/3 w-96 h-96 bg-accent-500 opacity-10 rounded-full blur-3xl", animate: {
                            ...
                            delay: 1,
                                        ...
                                        : 'from-slate-100/50 dark:from-slate-900/50 to-slate-150/50 dark:to-slate-950/50 border-slate-300/50 dark:border-slate-700/50 hover:border-accent-400/50'}`, children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-slate-300/20 dark:from-slate-900/20 to-transparent pointer-events-none" }), plan.highlight && (_jsx("div", { className: "absolute -top-3 left-1/2 transform -translate-x-1/2 z-10", children: _jsxs("div", { className: "flex items-center gap-1 px-3 py-1 bg-gradient-to-r from-accent-500 to-accent-400 rounded-full text-slate-950 text-xs font-semibold", children: [_jsx(Zap, { className: "w-3 h-3" }), "Most Popular"] }) })), _jsxs("div", { className: "relative z-10", children: [_jsxs("div", { className: "text-center mb-8 pt-4", children: [_jsx("h3", { className: "text-2xl font-semibold text-slate-900 dark:text-white mb-3", children: plan.name }), _jsxs("div", { className: "mb-4", children: [_jsx("span", { className: "text-5xl font-bold bg-gradient-to-r from-accent-400 to-accent-500 bg-clip-text text-transparent", children: plan.price }), _jsx("span", { className: "text-slate-700 dark:text-slate-300 text-sm", children: "/month" })] }), _jsx("p", { className: "text-slate-700 dark:text-slate-300 text-sm", children: plan.description })] }), _jsx("ul", { className: "space-y-3 mb-8", children: plan.features.map((feature, featureIndex) => (_jsxs("li", { className: "flex items-start gap-3", children: [_jsx(Check, { className: "w-5 h-5 text-accent-500 flex-shrink-0 mt-0.5" }), _jsx("span", { className: "text-slate-700 dark:text-slate-300 text-sm", children: feature })] }, featureIndex))) }), _jsx(Button, { variant: plan.highlight ? 'primary' : 'outline', size: "md", onClick: handleStartTrial, fullWidth: true, className: plan.highlight ? 'bg-gradient-to-r from-accent-500 to-accent-400 hover:from-accent-400 hover:to-accent-300 text-slate-950' : '', children: plan.ctaText })] })] })] }, index))) }), _jsxs(motion.div, { className: "mt-16 text-center", initial: { opacity: 0 }, whileInView: { opacity: 1 }, transition: { duration: 0.8, delay: 0.3 }, viewport: { once: true }, children: [_jsx("p", { className: "text-slate-700 dark:text-slate-300 mb-4 text-sm", children: "All plans include: Secure messaging, message history, reply inbox, and mobile access" }), _jsxs("p", { className: "text-sm text-slate-700 dark:text-slate-300", children: ["Need a custom plan?", ' ', _jsx("a", { href: "mailto:support@connect.com", className: "text-accent-400 hover:text-accent-300 font-semibold transition-colors", children: "Contact us" })] })] })] })] }));
}
