...
export default function Testimonials() {
  return (
    <section id="testimonials" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-warm-coffee to-warm-walnut-brown transition-colors duration-normal">
      <div className="max-w-7xl mx-auto">
        {/* Section Header */}
        <div className="text-center mb-16 animate-fadeIn">
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4 leading-tight tracking-tight">
            Trusted by <span className="text-warm-copper">Church Leaders</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <Card
              key={index}
              variant="default"
              className="animate-slideUp p-8 bg-gradient-to-br from-warm-raw-umber to-warm-coffee border border-warm-coyote hover:shadow-dual-lg transition-all duration-normal"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              {/* Quote Icon */}
              <div className="mb-6">
                <svg
                  className="w-10 h-10 text-warm-brown-sugar"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              {/* Content */}
              <p className="text-warm-50 mb-6 leading-relaxed italic">
                "{testimonial.content}"
              </p>

              {/* Author */}
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-warm-copper rounded-full flex items-center justify-center text-white font-semibold text-base flex-shrink-0">
        ...
        {/* Trust Indicators */}
        <div className="mt-16 pt-12 border-t border-warm-coyote">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-3xl font-bold text-warm-copper mb-2">100+</div>
              <div className="text-warm-100 text-sm">Churches</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-warm-copper mb-2">25K+</div>
              <div className="text-warm-100 text-sm">Members</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-warm-copper mb-2">500K+</div>
              <div className="text-warm-100 text-sm">Messages Sent</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-warm-copper mb-2">99.9%</div>
              <div className="text-warm-100 text-sm">Uptime</div>
            </div>
          </div>
        </div>
      </div>
