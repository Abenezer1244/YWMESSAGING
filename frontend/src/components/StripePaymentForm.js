...
export default function StripePaymentForm({ amount, phoneNumber, paymentIntentId, onSuccess, onError, isLoading = false, paymentStatus = 'idle', paymentMessage = '', }) {
