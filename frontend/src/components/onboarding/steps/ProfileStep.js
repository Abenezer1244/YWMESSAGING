...
const ProfileStep = ({ onNext, onBack }) => {
    ...
    return (_jsx(Card, { variant: "default", padding: "lg", children: _jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-2xl font-bold", children: "Set Up Your Profile" }), _jsx("p", { className: "text-muted-foreground mt-1", children: "Tell us a bit about yourself" })] }), _jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [_jsx(Input, { label: "Full Name", name: "fullName", value: formData.fullName, onChange: handleChange, error: errors.fullName, placeholder: "John Doe", autoComplete: "name", required: true }), _jsx(Input, { label: "Email Address", type: "email", name: "email", value: formData.email, onChange: handleChange, error: errors.email, placeholder: "you@company.com", autoComplete: "email", required: true }), _jsx(Input, { label: "Organization", name: "organization", value: formData.organization, onChange: handleChange, error: errors.organization, placeholder: "Acme Corporation", autoComplete: "organization", required: true }), _jsxs("div", { className: "flex gap-3 pt-4", children: [_jsx("button", { type: "button", onClick: onBack, className: "flex-1 px-4 py-2.5 border border-border rounded-sm font-medium hover:bg-muted/50 transition-all", children: "Back" }), _jsx("button", { type: "submit", className: "flex-1 bg-primary text-primary-foreground px-4 py-2.5 rounded-sm font-medium hover:opacity-90 transition-all", children: "Continue" })] })] })] }) }));
};
