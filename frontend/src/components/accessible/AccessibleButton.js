 ...
 */
const AccessibleButton = React.forwardRef(({ label, icon, variant = 'primary', size = 'md', isLoading = false, disabled = false, fullWidth = false, ariaLabel, className = '', onClick, ...props }, ref) => {
    ...
    return (_jsxs("button", { ref: ref, style: baseStyles, disabled: disabled || isLoading, "aria-label": ariaLabel || label, "aria-busy": isLoading, "aria-disabled": disabled, onClick: handleClick, className: className, ...props, children: [isLoading && (_jsx("span", { "aria-hidden": "true", style: {
                    display: 'inline-block',
                    animation: 'spin 1s linear infinite',
                    width: '1em',
                    height: '1em',
                    marginRight: designTokens.spacing.xs
                }, children: "\u27F3" })), icon && !isLoading && (_jsx("span", { "aria-hidden": "true", style: { display: 'flex', alignItems: 'center' }, children: icon })), _jsx("span", { children: label })] }));
});
