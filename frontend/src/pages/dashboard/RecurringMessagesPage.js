...
export function RecurringMessagesPage() {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-slate-950 p-6 transition-colors duration-normal", children: [_jsxs("div", { className: "max-w-7xl mx-auto", children: [_jsx("div", { className: "mb-6", children: _jsx(BackButton, { variant: "ghost" }) }), _jsxs("div", { className: "flex items-center justify-between mb-8", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-4xl font-bold text-white mb-2", children: "\uD83D\uDD04 Recurring Messages" }), _jsx("p", { className: "text-slate-300", children: "Automate regular communications" })] }), _jsx(Button, { variant: "primary", size: "lg", onClick: handleCreate, children: "+ Create Recurring Message" })] }), isLoading ? (_jsx("div", { className: "flex items-center justify-center py-20", children: _jsx(Spinner, { size: "lg", text: "Loading recurring messages..." }) })) : messages.length === 0 ? (_jsxs(Card, { variant: "highlight", className: "text-center py-16 bg-slate-900/50 border-slate-700", children: [_jsx("div", { className: "mb-6", children: _jsx("span", { className: "text-6xl", children: "\uD83D\uDD04" }) }), _jsx("h2", { className: "text-2xl font-bold text-white mb-3", children: "No Recurring Messages Yet" }), _jsx("p", { className: "text-slate-300 mb-6 max-w-md mx-auto", children: "Create recurring messages to automatically send messages on a regular schedule." }), _jsx(Button, { variant: "primary", size: "md", onClick: handleCreate, children: "Create First Message" })] })) : (_jsx("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: messages.map((message) => (_jsxs(Card, { variant: "default", className: `hover:shadow-lg transition-shadow bg-slate-900/50 border-slate-700 ${!message.isActive ? 'opacity-75' : ''}`, children: [_jsxs("div", { className: "flex items-start justify-between mb-4", children: [_jsxs("div", { className: "flex-1", children: [_jsx("h3", { className: "text-lg font-semibold text-white", children: message.name }), _jsx("p", { className: "text-sm text-slate-300 mt-1", children: getFrequencyLabel(message.frequency) })] }), _jsx("button", { onClick: () => handleToggle(message.id, message.isActive), className: `px-3 py-1 rounded-full text-xs font-semibold transition-colors ${message.isActive
