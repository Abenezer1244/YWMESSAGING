...
export function SendMessagePage() {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-background p-6 transition-colors duration-normal", children: [_jsxs("div", { className: "max-w-4xl mx-auto", children: [_jsx("div", { className: "mb-6", children: _jsx(BackButton, { variant: "ghost" }) }), _jsx("div", { className: "flex items-center justify-between mb-8", children: _jsxs("div", { children: [_jsx("h1", { className: "text-4xl font-bold text-foreground mb-2", children: "\uD83D\uDCE8 Send Message" }), _jsx("p", { className: "text-foreground/80", children: "Reach your congregation with direct SMS messages" })] }) }), _jsxs(Card, { variant: "default", className: "space-y-6", children: [templates.length > 0 && (_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-foreground mb-3", children: "\uD83D\uDCCB Use Template" }), _jsxs("div", { className: "flex gap-2 flex-wrap", children: [templates.slice(0, 6).map((template) => (_jsx(Button, { variant: "secondary", size: "sm", onClick: () => handleUseTemplate(template), title: template.content, children: template.name }, template.id))), templates.length > 6 && (_jsx(Button, { variant: "outline", size: "sm", onClick: () => window.location.href = '/templates', children: "More Templates..." }))] })] })), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-foreground mb-3", children: "\u270D\uFE0F Message Content" }), _jsx("textarea", { value: content, onChange: (e) => setContent(e.target.value.slice(0, 1600)), className: "w-full px-4 py-3 border border-border rounded-lg bg-input text-foreground placeholder-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary resize-none transition-colors duration-normal", rows: 6, placeholder: "Type your message here...", maxLength: 1600 }), _jsxs("div", { className: "flex justify-between mt-3 text-sm text-muted-foreground", children: [_jsxs("span", { children: [content.length, " / 1600 characters"] }), _jsxs("span", { children: [segments, " SMS segment", segments !== 1 ? 's' : '', segments > 0 && ` ($${(segments * 0.0075).toFixed(4)} per recipient)`] })] }), content.trim() && (_jsx(Button, { variant: "ghost", size: "sm", onClick: () => setShowSaveModal(true), className: "mt-2", children: "\uD83D\uDCBE Save as Template" }))] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-foreground mb-3", children: "\uD83D\uDC65 Send To" }), _jsxs("div", { className: "space-y-3", children: [_jsxs("label", { className: "flex items-center gap-3 cursor-pointer group", children: [_jsx("input", { type: "radio", name: "targetType", value: "groups", checked: targetType === 'groups', onChange: (e) => setTargetType(e.target.value), className: "w-4 h-4 accent-primary cursor-pointer" }), _jsx("span", { className: "text-sm font-medium text-foreground", children: "Select Groups" })] }), targetType === 'groups' && (_jsx("div", { className: "ml-7 space-y-2 bg-muted p-4 rounded-lg border border-border", children: groups.length === 0 ? (_jsx("p", { className: "text-muted-foreground text-sm", children: "No groups available" })) : (groups.map((group) => (_jsxs("label", { className: "flex items-center gap-3 cursor-pointer group", children: [_jsx("input", { type: "checkbox", checked: selectedGroupIds.includes(group.id), onChange: () => handleGroupToggle(group.id), className: "w-4 h-4 rounded accent-primary cursor-pointer" }), _jsxs("span", { className: "text-sm text-foreground/80", children: [group.name, " (", group.memberCount, " members)"] })] }, group.id)))) })), _jsxs("label", { className: "flex items-center gap-3 cursor-pointer group", children: [_jsx("input", { type: "radio", name: "targetType", value: "all", checked: targetType === 'all', onChange: (e) => setTargetType(e.target.value), className: "w-4 h-4 accent-primary cursor-pointer" }), _jsx("span", { className: "text-sm font-medium text-foreground", children: "All Members" })] })] })] }), (targetType === 'all' || selectedGroupIds.length > 0) && segments > 0 && (_jsx(Card, { variant: "highlight", children: _jsxs("div", { className: "space-y-2 text-sm", children: [_jsxs("div", { className: "flex justify-between", children: [_jsx("span", { className: "text-foreground/80", children: "Recipients:" }), _jsx("span", { className: "font-medium text-foreground", children: recipientCount })] }), _jsxs("div", { className: "flex justify-between", children: [_jsx("span", { className: "text-foreground/80", children: "Segments:" }), _jsx("span", { className: "font-medium text-foreground", children: segments })] }), _jsxs("div", { className: "flex justify-between border-t border-border pt-2", children: [_jsx("span", { className: "font-medium text-foreground", children: "Estimated Cost:" }), _jsxs("span", { className: "font-bold text-primary", children: ["$", totalCost.toFixed(2)] })] })] }) })), _jsxs("div", { className: "flex gap-3 pt-4", children: [_jsx(Button, { variant: "secondary", size: "md", onClick: () => {
                                            setContent('');
                                            setSelectedGroupIds([]);
