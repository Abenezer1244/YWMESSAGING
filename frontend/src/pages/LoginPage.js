...
export function LoginPage() {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gradient-to-br from-white to-primary-50 dark:from-primary-950 dark:to-primary-900 flex items-center justify-center p-4 relative overflow-hidden", children: [_jsx("div", { className: "absolute top-0 right-0 w-96 h-96 bg-accent-500 opacity-10 rounded-full blur-3xl pointer-events-none" }), _jsxs("div", { className: "w-full max-w-md relative z-10 animate-fadeIn", children: [_jsxs("div", { className: "text-center mb-12", children: [_jsx("div", { className: "flex items-center justify-center mb-6", children: _jsx("div", { className: "w-14 h-14 bg-accent-500 rounded-xl flex items-center justify-center shadow-md hover:shadow-lg transition-shadow", children: _jsx("span", { className: "text-primary-900 font-bold text-2xl", children: "C" }) }) }), _jsx("h1", { className: "text-4xl font-bold text-neutral-900 dark:text-white mb-3 tracking-tight", children: "Welcome Back" }), _jsx("p", { className: "text-lg text-neutral-600 dark:text-neutral-400 font-light", children: "Church SMS Communication Platform" })] }), _jsxs(Card, { variant: "default", className: "p-8 border border-neutral-200 dark:border-neutral-800 shadow-lg", children: [_jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-5", children: [_jsx("div", { children: _jsx(Input, { label: "Email Address", type: "email", placeholder: "pastor@church.com", disabled: isLoading, error: errors.email?.message, ...register('email', {
