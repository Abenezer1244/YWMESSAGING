  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-6">
        <label className="flex items-start gap-3">
          ...
          <span className="text-sm text-slate-300">
            ...
            and{' '}
            <a href="/privacy" className="text-accent-400 hover:text-accent-300 font-semibold">
              Privacy Policy
            </a>
          </span>
        </label>
      ...
      <div className="mt-4 text-center">
        <a href="/subscribe" className="text-accent-400 hover:text-accent-300 font-semibold">
          Back to plans
        </a>
      </div>
    </form>
