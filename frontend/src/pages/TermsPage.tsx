    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 p-6 transition-colors duration-normal">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-white mb-4">4. Limitations of Liability</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-white mb-4">5. Accuracy of Materials</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-white mb-4">6. User Responsibilities</h2>
            <p className="leading-relaxed mb-3">
