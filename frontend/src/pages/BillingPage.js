...
export function BillingPage() {
    ...
    if (isLoading) {
        return (_jsx("div", { className: "min-h-screen bg-white dark:bg-neutral-950 p-6 transition-colors duration-normal", children: _jsx("div", { className: "max-w-7xl mx-auto", children: _jsx("div", { className: "flex items-center justify-center py-20", children: _jsx(Spinner, { size: "lg", text: "Loading billing information..." }) }) }) }));
    }
    if (!planInfo) {
