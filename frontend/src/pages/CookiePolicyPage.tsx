        ...
        <div className="space-y-8 text-foreground/80">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-foreground/90 mb-2">Essential Cookies</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground/90 mb-2">Performance Cookies</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground/90 mb-2">Functional Cookies</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground/90 mb-2">Marketing Cookies</h3>
                <p className="leading-relaxed">
