  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 p-6 transition-colors duration-normal">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-2">Cookie Policy</h1>
        ...
        <div className="space-y-8 text-slate-700 dark:text-slate-300">
          ...
          {/* Types of Cookies */}
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-white mb-4">2. Types of Cookies We Use</h2>
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Functional Cookies</h3>
                <p className="leading-relaxed">
          ...
          {/* How We Use Cookies */}
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-white mb-4">3. How We Use Cookies</h2>
          ...
          {/* Third-Party Cookies */}
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-white mb-4">4. Third-Party Cookies</h2>
            <p className="leading-relaxed">
          ...
          {/* Cookie Control */}
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-white mb-4">5. How to Control Cookies</h2>
          ...
          {/* Data Protection */}
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-white mb-4">6. Data Protection</h2>
            <p className="leading-relaxed">
