...
test.describe('Admin Login Flow', () => {
    ...
    test('should show error for incorrect password', async () => {
        ...
        await expect(page.locator('text=/invalid credentials|incorrect password|authentication failed/i')).toBeVisible({ timeout: 5000 });
    });
...
//# sourceMappingURL=login.e2e.test.js.map