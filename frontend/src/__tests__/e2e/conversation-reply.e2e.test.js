        ...
        if (await firstConversation.isVisible()) {
            ...
            if (await replyInput.isVisible()) {
                ...
                if (await sendButton.isVisible()) {
                    await sendButton.click();
                    // Should show success
                    await expect(page.locator('text=/sent|delivered|success|reply sent/i')).toBeVisible({ timeout: 5000 });
                }
            }
        }
    });
        ...
        if (await firstConversation.isVisible()) {
            ...
            if (await replyInput.isVisible()) {
                ...
                if (await sendButton.isVisible()) {
                    ...
                    await sendButton.click();
                    // Both should be sent
                    await expect(page.locator('text=/sent|delivered|success/i')).toBeVisible({ timeout: 5000 });
                }
            }
        }
    });
...
//# sourceMappingURL=conversation-reply.e2e.test.js.map