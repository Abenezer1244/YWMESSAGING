...
describe('Auth Routes - Integration Tests', () => {
    ...
    describe('POST /api/auth/register', () => {
        ...
        test('✅ Should set httpOnly cookies on registration', async () => {
            ...
            const hasHttpOnlyAccessToken = cookieStrings.some((c) => c.includes('accessToken') && c.includes('HttpOnly'));
            const hasHttpOnlyRefreshToken = cookieStrings.some((c) => c.includes('refreshToken') && c.includes('HttpOnly'));
    ...
    describe('POST /api/auth/login', () => {
        ...
        test('✅ Should update lastLoginAt timestamp', async () => {
            ...
            expect(updatedAdmin.lastLoginAt.getTime()).toBeGreaterThanOrEqual(beforeLogin.getTime());
        });
    ...
    describe('POST /api/auth/refresh', () => {
        ...
        test('✅ Should set new httpOnly cookies on refresh', async () => {
            ...
            expect(setCookieHeader).toBeDefined();
            const cookieStrings = (Array.isArray(setCookieHeader) ? setCookieHeader : [setCookieHeader]);
            const hasNewAccessToken = cookieStrings.some((c) => c.includes('accessToken'));
    ...
    describe('POST /api/auth/logout', () => {
        ...
        test('✅ Should clear cookies on logout', async () => {
            ...
            expect(setCookieHeader).toBeDefined();
            const cookieStrings = (Array.isArray(setCookieHeader) ? setCookieHeader : [setCookieHeader]);
            const hasClearedAccessToken = cookieStrings.some((c) => c.includes('accessToken') && c.includes('Max-Age=0'));
