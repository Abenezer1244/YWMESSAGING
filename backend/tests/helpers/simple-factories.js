...
export class SimpleFactories {
    ...
    async cleanup() {
        try {
            await this.prisma.$executeRawUnsafe('TRUNCATE TABLE "ConversationMessage" CASCADE');
            await this.prisma.$executeRawUnsafe('TRUNCATE TABLE "Conversation" CASCADE');
            await this.prisma.$executeRawUnsafe('TRUNCATE TABLE "MessageRecipient" CASCADE');
 ...
 */
export function getSimpleFactories(prisma) {
    return new SimpleFactories(prisma);
}
//# sourceMappingURL=simple-factories.js.map