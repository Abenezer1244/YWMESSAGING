...
CREATE INDEX IF NOT EXISTS "Message_churchId_createdAt_idx" ON "Message"("churchId", "createdAt");
...
CREATE INDEX IF NOT EXISTS "MessageRecipient_messageId_status_idx" ON "MessageRecipient"("messageId", "status");
