 ...
 */
export function createAsyncSpan<T>(
  operationName: string,
 ...
 */
export async function createExternalApiSpan<T>(
  apiName: string,
  endpoint: string,
  fn: () => Promise<T> | T,
  context?: SpanContext
 ...
 */
export async function createJobSpan<T>(
  jobName: string,
  fn: () => Promise<T> | T,
  context?: SpanContext
): Promise<T> {
 ...
 */
export function trackTiming(name: string, duration: number, tags?: SpanContext): void {
 ...
 */
export function recordMetric(metricName: string, value: number, tags?: SpanContext): void {
  try {
 ...
 * }
 */
export function getRouteSpan(req: any, spanName: string, context?: SpanContext) {
