...
import {
  ...
  resolveLibraryId,
  getLibraryDocs,
} from '../services/mcp-agent-gateway.service.js';
 ...
 * }
 */
router.post('/ref/search', async (req: Request, res: Response) => {
  try {
 ...
 * }
 */
router.post('/ref/read', async (req: Request, res: Response) => {
  try {
    const { url } = req.body;
 ...
 * }
 */
router.post('/context7/resolve', async (req: Request, res: Response) => {
  try {
 ...
 * }
 */
router.post('/context7/docs', async (req: Request, res: Response) => {
  try {
