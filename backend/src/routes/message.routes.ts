...
router.post(
  '/rcs/announcement',
  authenticateToken,
  messageController.sendRichAnnouncement
);
...
router.post(
  '/rcs/event',
  authenticateToken,
  messageController.sendEventInvitation
);
...
router.post(
  '/rcs/schedule',
  authenticateToken,
  messageController.sendWeeklySchedule
);
...
router.get(
  '/rcs/status',
  authenticateToken,
  messageController.getRCSStatus
);
...
router.post(
  ...
  validateBody(ReplyToConversationSchema),
