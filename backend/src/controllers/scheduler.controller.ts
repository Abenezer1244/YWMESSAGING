...
interface SchedulerMetrics {
  lastRun: Date | null;
  churchesApprovedThisRun: number;
 ...
 */
export async function handleDLCApprovalCheck(req: Request, res: Response) {
 ...
 */
export async function manualTriggerDLCCheck(req: Request, res: Response) {
