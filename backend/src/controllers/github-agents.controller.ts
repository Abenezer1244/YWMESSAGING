 ...
 */
export async function handleGitHubAgentsWebhook(
  req: Request,
  res: Response
): Promise<void> {
  try {
 ...
 */
async function processGitHubWebhook(eventType: string, payload: any) {
  try {
 ...
 */
export async function checkGitHubWebhookHealth(
  req: Request,
  res: Response
): Promise<void> {
  res.status(200).json({
