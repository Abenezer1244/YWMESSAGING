 ...
 */
export function setDownloadHeaders(res, filename, contentType, disposition = 'attachment') {
    ...
    res.setHeader('Content-Disposition', `${disposition}; filename="${encodedFilename}"; filename*=UTF-8''${utf8Filename}`);
 ...
 */
function encodeUTF8Filename(filename) {
...
//# sourceMappingURL=download-headers.js.map